...
def upload_video_to_youtube(video_file, title, description, category, youtube_service):
    generic_description = (
        "Welcome to our channel! Enjoy this Reddit story from popular subreddits like "
        "nosleep, AmItheAsshole, tifu, relationships, confession, ProRevenge, and MaliciousCompliance. "
        "Don't forget to like, comment, and subscribe for more Reddit stories!"
    )
    ...
    generic_tags = ["Reddit", "stories", "shorts", "nosleep", "AmItheAsshole", "tifu",
        ...
        "Am I the Asshole stories explained",
...
def process(args):
    ...
    try:
        voices = {
            ...
            "female": {'voice': "en-US-EmmaNeural", 'pitch': '+0Hz'}
        }
